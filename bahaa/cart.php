            ...
            <table>
                ...
                <tr>
                    <td style="display: relative;">
                        <div style="display: relative; left: 0; margin: auto; display: flex; justify-content: space-between; align-items: center; width: 200px;">
                ...
                <tr>
                    <td style="display: relative;">
                        <div style="margin: auto; display: flex; justify-content: space-between; align-items: center; width: 200px;">
                            <i class="fa-solid fa-circle-xmark"></i>
